    ...
    return(
        <>
            <main className="depression-container">
                <ul>
                    <li className='dp-heading'>What is Depression?</li>
                    <li className='dp-desc'>Define depression as a common but serious mental health disorder that negatively affects how one feels, thinks, and acts.</li>
                    <li className='dp-desc'>Emphasize that it is treatable, and recovery is possible with the right support and treatment</li>
                    <li className='dp-heading'>Causes of Depression</li>
                    ...
                    <li className='dp-heading'>Solutions and Treatment for Depression</li>
                    <li className='dp-desc'>Therapy and Counseling</li>
                    <li className='dp-desc'>Medication </li>
